...
server.resource(
  "mfg://modules",
  "List of all Manufacturing Cloud modules with documentation",
  async () => {
...
server.prompt(
  "mfg_implementation_checklist",
  "Generate an implementation checklist for a Manufacturing Cloud module",
  {
    module: z
      .enum([
        "sales-agreements",
...
server.prompt(
  "mfg_troubleshoot",
  "Get help troubleshooting a Manufacturing Cloud issue",
  {
