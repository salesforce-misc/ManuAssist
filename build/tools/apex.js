...
export function register(server) {
    server.tool("run_apex", "Execute anonymous Apex code against the target Salesforce org. Use for one-off tasks like running batch jobs, fixing data issues, or testing logic. Returns compilation status, execution result, and debug logs.", {
